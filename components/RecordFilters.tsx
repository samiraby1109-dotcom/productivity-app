    ...
    <div className="mb-4">
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        >
          ...
          Filters
          {activeCount > 0 && (
            <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-brand-500 text-white text-[10px] font-medium">
              {activeCount}
            </span>
          )}
        </button>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {(["police", "children", "witness", "attachments"] as const).map((field) => (
                ...
                >
                  {field === "police" && "Police involved"}
                  {field === "children" && "Children involved"}
                  {field === "witness" && "Witnesses"}
                  {field === "attachments" && "Has files"}

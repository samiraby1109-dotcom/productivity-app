  ...
  return (
    <main className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="border-b border-gray-100 px-6 py-4 flex items-center justify-between">
        <span className="font-semibold text-gray-900 text-lg tracking-tight">Daybook</span>
        <Link
          href="/login"
      ...
      <footer className="border-t border-gray-100 py-6 px-6 text-center text-xs text-gray-400">
        <p>Daybook &copy; {new Date().getFullYear()} &mdash; A private productivity tracker.</p>
      </footer>
    </main>
  );
}

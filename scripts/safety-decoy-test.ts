...
async function main() {
  ...
  for (const p of ["/tools", "/tools/records", `/tools/records/${recId}`, "/tools/export", "/tools/records/new", "/tools/recovery", "/tools/archive", "/tools/contacts", "/tools/safety", "/tools/risk", "/tools/guides", "/tools/resources", "/tools/security"]) {
